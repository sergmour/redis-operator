...
func (in *RedisReplicationSpec) DeepCopyInto(out *RedisReplicationSpec) {
	*out = *in
	...
	if in.ExternalMaster != nil {
		in, out := &in.ExternalMaster, &out.ExternalMaster
		*out = new(ExternalMasterConfig)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalMasterConfig) DeepCopyInto(out *ExternalMasterConfig) {
	*out = *in
	if in.Port != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalMasterConfig.
func (in *ExternalMasterConfig) DeepCopy() *ExternalMasterConfig {
	if in == nil {
		return nil
	}
	out := new(ExternalMasterConfig)
